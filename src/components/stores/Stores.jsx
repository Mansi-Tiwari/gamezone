        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          {data.store_data.map((item) => (
            ...
            >
              ...
              <div className="store-item-info w-[300px] mx-auto ">
                ...
                <ul>
                  <li className="text-dark cursor-pointer group-hover:text-white transition ease-in-out duration-300">
                    <span className="me-1 font-bold flex flex-wrap mx-auto ">
                      Domain:
                    </span>
                  ...
                  <li className="text-dark flex group-hover:text-white mx-auto transition ease-in-out duration-300">
